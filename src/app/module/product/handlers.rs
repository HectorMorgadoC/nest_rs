pub(crate) mod handler {
    ...
    use crate::app::shared::common::{http_error::http_error::HttpResult,message_detail::message_detail::Details};    
    ...
    pub async fn get_by_id_product(service: web::Data<Services>,_id: web::Path<Uuid>) -> HttpResult<HttpResponse> {
    ...
    pub async fn update_product(
        ...
        _id: web::Path<Uuid>) -> HttpResult<HttpResponse> {
        println!("PUT: /product");
        let id = _id.into_inner();
    ...
    pub async fn delete_product(service: web::Data<Services>,_id: web::Path<Uuid>) -> HttpResult<HttpResponse> {
