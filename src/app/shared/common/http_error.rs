pub mod http_error {
    ...
    use actix_web::{Error, HttpResponse, ResponseError, Result as ActixResult, http::StatusCode};
    use serde::Serialize;
    use std::fmt;
    ...
    impl ProblemDetails {
        ...
        pub fn bad_request(detail: String) -> Self {
            ProblemDetails::new(None, "Bad Request".to_string(), 400, detail)
        }
        ...
        pub fn unprocesable_entity(detail: String) -> Self {
            ProblemDetails::new(None, "Unprocesable Entity".to_string(), 422, detail)
        }

        pub fn conflict(detail: String) -> Self {
            ProblemDetails::new(None, "Conflict".to_string(), 409, detail)
        }

        pub fn unauthorized(detail: String) -> Self {
            ProblemDetails::new(None, "Unauthorized".to_string(), 401, detail)
        }

        pub fn forbidden(detail: String) -> Self {
            ProblemDetails::new(None, "Forbidden".to_string(), 403, detail)
        }
        ...
        pub fn not_content(detail: String) -> Self {
            ProblemDetails::new(None, "Not Content".to_string(), 204, detail)
        }
    }
